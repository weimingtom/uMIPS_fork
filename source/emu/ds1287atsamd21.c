...
static bool ds1287prvMemAccess(uint32_t pa, uint_fast8_t size, bool write, void* buf, void* userData)
{
	uint_fast8_t val;
...
void __attribute__((used)) TC4_IRQHandler(void)
{
...
void __attribute__((used)) TC5_IRQHandler(void)
{
...
bool ds1287init(void)
{
	...
	//add memory
	return memRegionAdd(0x1d000000, 0x01000000, ds1287prvMemAccess, (void*)0);
}
